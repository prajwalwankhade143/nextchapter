...
# ===============================
    ...
    shayari_list = [
        ...
        "मोहब्बत की सबसे बड़ी सज़ा – यादें।",
        "हम आज भी मुस्कुरा देते हैं, दर्द छुपाने के लिए।",
        "तुम पास नहीं फिर भी तुम्हारा असर है।",
        "खामोशी भी एक जवाब होती है।",
        "दिल ने छोड़ना चाहा, आदत ने नहीं।",
        "हमने खोया बहुत कुछ, पर शिकायत नहीं की।",
    ...
    st.markdown(
        ...
        <div class="card" style="font-size:18px;">
            {shayari_list[st.session_state.shayari_index]}
        </div>
        """,
        unsafe_allow_html=True
    )
    ...
    if st.button("➕ Ek aur Shayari"):
        st.session_state.shayari_index = (
